...
/*Comment: DIO Pin index assignayion                                             */
...
/*Decription: the function shall set the direction of a certain DIO Channel     */
u8 DIO_u8SetPinDir(u8 Copy_u8PinId,u8 Copy_PinDir);
